...
<template>
  ...
  <template v-else>
    <div class="pageTitle">
      ...
      <div class="right">
        <button v-if="!isEdit" class="btn btn--primary" @click="goEdit">Edit</button>
        <button class="btn" @click="goBack">Back</button>
      </div>
    </div>
    ...
    <div v-if="!isEdit" class="card">
      <div class="detailsGrid">
        <div class="kv"><div class="k">Occupation</div><div class="v">{{ employee.occupation }}</div></div>
        <div class="kv"><div class="k">Department</div><div class="v">{{ employee.department }}</div></div>
        <div class="kv"><div class="k">Employment</div><div class="v">{{ employmentStatusLabel(employee.dateOfEmployment) }}</div></div>
        <div class="kv"><div class="k">Termination</div><div class="v">{{ terminationStatusLabel(employee.terminationDate) }}</div></div>
      </div>
    </div>
