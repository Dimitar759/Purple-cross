...
const query = ref('')
const sortKey = ref<'fullName' | 'occupation' | 'department' | 'dateOfEmployment'>('fullName')
...
<template>
  <section class="card">
    <div class="toolbar">
      <input class="input" v-model="query" placeholder="Search by name, code, department..." />
      <div class="sort">
        <span class="muted">Sort:</span>
        <button class="btn btn--ghost" @click="setSort('fullName')">Name</button>
        <button class="btn btn--ghost" @click="setSort('department')">Dept</button>
        <button class="btn btn--ghost" @click="setSort('dateOfEmployment')">Employment</button>
      </div>
    </div>
      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th @click="setSort('occupation')" class="thClickable">Occupation</th>
            <th @click="setSort('department')" class="thClickable">Department</th>
            <th @click="setSort('dateOfEmployment')" class="thClickable">Date of Employment</th>
        ...
        <tbody>
          <tr v-for="e in filteredSorted" :key="e.code">
            <td>
              <div class="nameCell">
            ...
            <td class="right actions">
              ...
              <button class="btn btn--danger" @click="emit('requestDelete', e.code)">Delete</button>
            </td>
          </tr>
